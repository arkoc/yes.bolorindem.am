...
const L = {
 ...
 heatmap: {
  ...
  elections: {
    ...
    stepCitizenshipTitle: "Քաղաքացիություն",
    citizenshipText: "Հաստատում եմ, որ հանդիսանում եմ ՀՀ քաղաքացի:",
    acceptCitizenship: "Հաստատում եմ քաղաքացիությունս",
    ...
    stepOnlyArmenianTitle: "Միայն ՀՀ քաղաքացիություն",
    onlyArmenianText: "Հաստատում եմ, որ չունեմ այլ երկրի քաղաքացիություն:",
    acceptOnlyArmenian: "Չունեմ այլ քաղաքացիություն",
    stepLivedInArmeniaTitle: "Բնակություն Հայաստանում",
    livedInArmeniaText: "Հաստատում եմ, որ վերջին 4 տարում հիմնականում բնակվել եմ Հայաստանում:",
    acceptLivedInArmenia: "Ապրել եմ Հայաստանում վերջին 4 տարին",
    stepArmenianSchoolTitle: "Կրթություն",
