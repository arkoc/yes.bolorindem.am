-- Replace single cover_image_url with image_urls array for multiple attachments.
ALTER TABLE user_bounties DROP COLUMN IF EXISTS cover_image_url;
ALTER TABLE user_bounties ADD COLUMN IF NOT EXISTS image_urls TEXT[] NOT NULL DEFAULT '{}';
